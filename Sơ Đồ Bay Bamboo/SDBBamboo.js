...
var TieuDeChuyenMuc = "Chuyên Mục: Sơ đồ bay - Bamboo Airways";
...
var Map1 = "../Picture/BambooAirwaysFlightMapDomestic.jpg";
var Map2 = "../Picture/BambooAirwaysFlightMapInternational.jpg";
...
function XULITHONGTINHINHANH()
{
	...
	$("#DomesticFLightInfo").attr("src",Map1);
	$("#InternationalFLightInfo").attr("src",Map2);
}